...
Last updated: 2026-08-28 (branch `fix-audio-ancestral-axis-mismatch`). Bug E: ramp-length FALSIFIED (L=55 both clean+error); M-B/M-D/M-E confounded clip=90; held-band[28-39] new (M-E); decoupler 0/0/50/70, 0/0/35/65 + code-quant dig pending.
...
- [long-fade-grid-beat.md](per-row-img2img/long-fade-grid-beat.md): **THEORY (UNVERIFIED — M-A/M-C/S2 falsified; survivors M-B/M-D/M-E confounded):** ramp FALSIFIED; held-band[28-39] (M-E); decoupler+code-quant pending. *Read for Bug E.*
