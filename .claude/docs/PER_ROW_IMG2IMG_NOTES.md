...
Last updated: 2026-08-28 (branch `fix-audio-ancestral-axis-mismatch`). Bug E: noise at fade midpoint (fr.~60-64); 4-model confound, M-D added; shift-series pending — [long-fade-grid-beat.md](per-row-img2img/long-fade-grid-beat.md).
...
- [long-fade-grid-beat.md](per-row-img2img/long-fade-grid-beat.md): **THEORY (UNVERIFIED — S2 GPU-falsified; 4-model confound M-A/B/C/D):** Bug E — L∈~[51,64]; noise at fade midpoint; M-D added; shift-series PENDING. *Read for Bug E.*
