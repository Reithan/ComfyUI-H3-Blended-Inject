...
Last updated: 2026-08-28 (branch `fix-audio-ancestral-axis-mismatch`). Bug E: snap/rounding FALSIFIED two-sided (Fable 13-config); gate downstream GPU; M-B/M-D/M-E confounded; decouplers 0/0/50/70, 0/0/35/65 + 0/0/60/90 pending.
...
- [long-fade-grid-beat.md](per-row-img2img/long-fade-grid-beat.md): **THEORY (UNVERIFIED — M-A/M-C/S2/snap-rounding falsified; survivors M-B/M-D/M-E confounded):** decouplers 0/0/50/70, 0/0/35/65 + 0/0/60/90 pending. *Read for Bug E.*
