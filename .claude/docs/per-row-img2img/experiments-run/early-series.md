...
| HOLD-9 | proto · r40 · md=0.0 · hold=0.0 vs 0.5 A/B · euler/20-step | hold=0.5 armed 1,084,864 elems (opening fade-out, not keyframes) → no attraction | [hold-mechanism-and-confounds.md](../latent-hold-release/hold-mechanism-and-confounds.md) |
| HOLD-11 | 0.5MP · r40+r60 · md=0.5 · hold=0.5, provenance fix · euler/20-step | Armed 1.08M→97,920; r40 blends; r40 itself under-denoises (Finding 12) | [hold-mechanism-and-confounds.md](../latent-hold-release/hold-mechanism-and-confounds.md) |
